...
USER_NAME = os.environ['USER_NAME']  # 'sarthak-env'
QUERY_COUNT = {'user_getter': 0, 'follower_getter': 0, 'graph_repos_stars': 0, 'recursive_loc': 0, 'graph_commits': 0, 'loc_query': 0}

# TODO: set this to your actual birthday (year, month, day). It drives the "Uptime" field on the card.
BIRTHDAY = datetime.datetime(2004, 9, 2)
